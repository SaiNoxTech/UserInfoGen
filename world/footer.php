    ...
    <div class="row">
      <div class="col-sm-12 col-lg-4 pr-5 mb-4">
        ...
        <div class="social-icons sty1">
          <ul class="list-inline">
            ...
            <li class="list-inline-item"><a href="index-7.html#"><i class="fa fa-facebook"></i></a></li>
            <li class="list-inline-item"><a href="index-7.html#"><i class="fa fa-twitter"></i></a></li>
            <li class="list-inline-item"><a href="index-7.html#"><i class="fa fa-google-plus"></i></a></li>
            <li class="list-inline-item"><a href="index-7.html#"><i class="fa fa-linkedin"></i></a></li>
          </ul>
        </div>
      </div>
      <div class="col-sm-4 col-lg-2 mb-4">
        ...
        <ul class="list-unstyled">
          ...
          <li><a href="index-7.html#">CC checker</a></li>
          <li><a href="index-7.html#">CC Generator</a></li>
          <li><a href="index-7.html#">Disposable Emails</a></li>
          <li><a href="index-7.html#">Username Generator</a></li>
          <li><a href="index-7.html#">Password Generator</a></li>
        </ul>
      </div>
